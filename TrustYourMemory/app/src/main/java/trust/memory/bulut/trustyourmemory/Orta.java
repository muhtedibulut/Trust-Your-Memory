...
public class Orta extends AppCompatActivity {
    ...
    //TextView[][] gosterim = new TextView[4][4];
    ...
    private String reklam="ca-app-pub-2467257044607400/4809971970";
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onFinish() {
                ...
                timer1 = new CountDownTimer(15000, 1000) {
                    ...
                    public void onFinish() {
                        ...
                        Intent intent = new Intent(Orta.this, GameOver.class);
                        /*Scoru GameOver sayfasına gönder*/
                        intent.putExtra("puan",(level - 2));
                        intent.putExtra("derece",4);
        ...
        timer2 = new CountDownTimer(5000, 1000) {
            ...
            public void onFinish() {
                ...
                buton_enabled(true);
                /*kullanıcının sayıları bilmesi için 40 saniye verilir*/
                timer3 = new CountDownTimer(15000, 1000) {
                    @Override
                    public void onTick(long l) {
                        /*saniye 5'ten büyükse saniyeyi siyah renkle göster değilse kırmızı renkle göster*/
                        if(l/1000 >5)
    ...
    public void onBackPressed() {
        ...
        timer.cancel();*/
        Intent intent = new Intent(Orta.this, Basla.class);
        startActivity(intent);
    }
