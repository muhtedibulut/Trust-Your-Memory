...
public class Zor extends AppCompatActivity {
    ...
    //TextView[][] gosterim = new TextView[5][5];
    ...
    private String reklam="ca-app-pub-2467257044607400/7763438377";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gosterim[0][3] = (TextView) findViewById(R.id.t03);
        gosterim[0][4] = (TextView) findViewById(R.id.t04);
        ...
        gosterim[1][3] = (TextView) findViewById(R.id.t13);
        gosterim[1][4] = (TextView) findViewById(R.id.t14);
        ...
        gosterim[2][3] = (TextView) findViewById(R.id.t23);
        gosterim[2][4] = (TextView) findViewById(R.id.t24);
        gosterim[3][0] = (TextView) findViewById(R.id.t30);
        gosterim[3][1] = (TextView) findViewById(R.id.t31);
        gosterim[3][2] = (TextView) findViewById(R.id.t32);
        gosterim[3][3] = (TextView) findViewById(R.id.t33);
        gosterim[3][4] = (TextView) findViewById(R.id.t34);
        gosterim[4][0] = (TextView) findViewById(R.id.t40);
        gosterim[4][1] = (TextView) findViewById(R.id.t41);
        gosterim[4][2] = (TextView) findViewById(R.id.t42);
        gosterim[4][3] = (TextView) findViewById(R.id.t43);
        gosterim[4][4] = (TextView) findViewById(R.id.t44);*/
        ...
        timer = new CountDownTimer(3000, 1000) {
            ...
            public void onFinish() {
                ...
                buton_enabled(true);
                /*kullanıcının sayıları bilmesi için 40 saniye verilir*/
                timer1 = new CountDownTimer(20000, 1000) {
                    ...
                    /*40 saniye bittiğinde kullanıcı verilen saniye içinde bilememiş demektir ve saniye bittikten sonra yapılacak olanlar*/
                    @Override
                    public void onFinish() {
                        /*GameOver sayfasına git*/
                        Intent intent = new Intent(Zor.this, GameOver.class);
                        /*Scoru GameOver sayfasına gönder*/
                        intent.putExtra("puan",(level - 2));
                        intent.putExtra("derece",5);
    ...
    public void onBackPressed() {
        ...
        timer.cancel();*/
        Intent intent = new Intent(Zor.this, Basla.class);
        startActivity(intent);
    }
